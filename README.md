...
```bash
git clone https://github.com/kloza15/dotfile-kde-6.git && cd dotfile-kde-6 && chmod +x install-fastfetch-v1-dotfile-kde-6.sh && ./install-fastfetch-v1-dotfile-kde-6.sh
```
